...
https://github.com/novenOo/novenOo.github.io
## Function
### AJAX Requests
- [x] All AJAX requests work properly.
- [o] Large images, videos, and other media — anything that would significantly slow down the user's browsing experience — are loaded via AJAX requests.
...
- [o] Homepage loads well-styled content even when JavaScript is disabled.
